    ...
    >
      ...
      >
        <Box>
          ...
          >
            {t('dashboard_car_workload')}
          </Typography>
          <Typography variant="h4">{t('dashboard_car_by_category')}</Typography>
        </Box>
        <IconButton
          size="small"
          color="primary"
...
export default OccupancyСategory;
