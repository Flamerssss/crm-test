      ...
      >
        <ThemeToggleWrapper>
          ...
          <Stack alignItems="center" spacing={2}>
            <Tooltip placement="left" title={t('Pure_Light')} arrow>
              <ButtonWrapper
            ...
            <Tooltip placement="left" title={t('Grey_Goose')} arrow>
              <ButtonWrapper
            ...
            <Tooltip placement="left" title={t('Purple_Flow')} arrow>
              <ButtonWrapper
        ...
        <ThemeToggleWrapper>
          <Typography
            ...
            variant="body1"
          >
            {t('Dark_color_schemes')}
          </Typography>
          <Stack alignItems="center" spacing={2}>
            <Tooltip placement="left" title={t('Nebula_Fighter')} arrow>
              <ButtonWrapper
            ...
            <Tooltip placement="left" title={t('Green_Fields')} arrow>
              <ButtonWrapper
            ...
            <Tooltip placement="left" title={t('Dark_Spaces')} arrow>
              <ButtonWrapper
