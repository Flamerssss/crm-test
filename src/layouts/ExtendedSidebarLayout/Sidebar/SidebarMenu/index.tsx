...
function SidebarMenu() {
  ...
  console.log('companyStore.company_profile undefined', companyStore.company_profile['type'])

  return (
    <>
      <MenuWrapper key={'QuickTransition'}>
      </MenuWrapper>
      <MenuWrapper key={'Management'}>
        <List
          component="div"
          subheader={
            ...
            items: [
              {
                ...
                items: [
                  ...(companyStore.permissions.find(permission => permission.type === 'maintenance_rules')?.['can_view'] === true ? [
                    {
                      name: 'Maintenance',
                      link: '/maintenance'
                    },
